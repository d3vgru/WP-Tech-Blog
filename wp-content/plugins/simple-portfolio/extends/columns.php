...
function portfolio_edit_columns( $columns )
{
	$columns = array(
		...
		"title" => __('Project', 'simple-portfolio'),
		"permalink" => __('Permalink', 'simple-portfolio'),
		"media" => __('Number of media', 'simple-portfolio'),
		"clients" => __('Client(s)', 'simple-portfolio'),
		"pcategories" => __('Categories', 'simple-portfolio'),
		"ptags" => __('Tags', 'simple-portfolio')
	);
